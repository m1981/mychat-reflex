...
*   **Writes:** `/1-product-specs/` (Feature Specs), `/3-contracts/` (API/DB Contracts).
...
*   **Reads:** `/1-product-specs/`, `/3-contracts/`, `00-START-HERE.md`.
...
*   **Reads:** `tests/integration/` (The failing tests), `/1-product-specs/` (The Law), `/3-contracts/`.
