...
## 2. Decision
[What is the exact change or technology we are adopting? E.g., "We will use Server-Sent Events (SSE) instead of WebSockets for LLM streaming."]

## 3. Alternatives Considered
*   **[Alternative 1]:** [Why was it rejected?]
